        ...
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 rounded-3xl bg-brand-green/15 px-6 py-8 text-center text-brand-cream sm:px-8 sm:py-10 lg:flex-row lg:text-left">
          <div className="space-y-4">
            ...
            <h2 className="text-2xl font-bold tracking-tight text-white sm:text-3xl">
              Need a professional fence crew in Palm Coast?
            </h2>
            <p className="mt-2 max-w-xl text-sm text-brand-cream/90 sm:text-base">
              We handle permits, HOA approvals, and installation with premium materials so your property stays secure and beautiful.
            </p>
          </div>
          ...
          <div className="flex w-full flex-col gap-3 sm:flex-row sm:justify-end">
            <Link
              ...
              className="
                ...
                rounded-full
                bg-brand-yellow px-6 py-3
                text-sm sm:text-base font-semibold text-brand-deep
                shadow-md shadow-black/15
                transition-transform transition-shadow duration-150
                hover:bg-brand-light hover:shadow-lg hover:-translate-y-[1px]
            ...
            <Link
              ...
              className="
                ...
                px-6 py-3
                text-sm sm:text-base font-semibold text-brand-cream
                bg-transparent
                shadow-sm shadow-black/10
                transition-transform transition-shadow duration-150
                hover:bg-white/10 hover:shadow-lg hover:-translate-y-[1px]
                focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-cream
                focus-visible:ring-offset-2 focus-visible:ring-offset-brand-deep
              "
            >
              Contact Us
